    ...
    def Fit(self, steps=1000):
        ...
        while (count < steps):
            ...
            if type(input_batch) is np.ndarray:
                ...
                print("---type(input_batch) is np.ndarray---")
...
class SummaryManager(object):
    def __init__(self, summary_dir, model_graph, freq_list, mode='train'):
        ...
        self.mode = mode
        print("Summary manager checkpoint 1")
        ...
        print("Summary manager checkpoint 2")
        ...
        print("Summary manager checkpoint 3")
        # Initialise the counts
        self.counts = {'train': {},'valid': {}}
        print("Summary manager checkpoint 4")
        # Initialise the counts
